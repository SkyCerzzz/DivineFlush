function DF.append_to_family(existing_name, new_name, to_end)
...
---@deprecated
function DF.add_megas_to_center(center_key, new_mega)
  local center = SMODS.Joker.obj_table[center_key]
  center.megas = center.megas or {}
  table.insert(center.megas, new_mega)
  DF.hookafterfunc(center, 'loc_vars', function(self, info_queue, _center)
