...
function DF.target_utils.find_card(key_or_func, use_highlighted)
  local results = {}
  ...
  ---@diDFnostic disable-next-line: missing-parameter
...
function DF.target_utils.find_leftmost(key_or_func, use_highlighted)
  return DF.target_utils.find_card(key_or_func, use_highlighted)[1]
end

function DF.target_utils.find_leftmost_or_highlighted(key_or_func)
  return DF.target_utils.find_leftmost(key_or_func, true)
end
