...
local function update_centers(config_key, enable)
  for _, center in pairs(G.P_CENTERS) do
    if center.divineflush_config_key == config_key then
      center.no_collection = not enable
    end
  end
end

function G.FUNCS.divineflush_toggle_settings_tile(e)
...
function DFTile:render()
  ...
  return {
    ...
    config = {
      ...
      button = "divineflush_toggle_settings_tile",
