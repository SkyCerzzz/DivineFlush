    ...
    "to add a {C:red}Red Seal{}",
      ...
      c_DF_blizzard = {
        ...
        text = {
          ...
          "{C:inactive}(Only if you have Calyrex (Ice Rider))",
          "{br:2}ERROR - CONTACT STEAK",
          "{C:attention}Status:{} #1#",
          "{C:attention}Rounds until ready:{} #2#",
          "{C:inactive}(Requires visible hand)",
          "{C:inactive}(If no Calyrex (Ice Rider), this shatters after use)",
        },
      },
      ...
      c_DF_resurrect = {
        ...
        text = {
          ...
          "{C:attention}Status:{} #1#",
          "{C:attention}Rounds until ready:{} #2#",
          "{C:inactive}(If no Calyrex (Shadow Rider), it shatters after use)",
        },
      },
    },
